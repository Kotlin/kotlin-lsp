...
import com.intellij.workspaceModel.integrationTests.data.maven.mavenEmptyProjectCustomSrcRoot.mavenEmptyProjectCustomSrcRootModulesData
...
class ImportMavenEmptyProjectCustomSrcRootTest {
    ...
    fun importMavenEmptyProjectCustomSrcRoot() {
        mavenTest(TestCases.IU.MavenEmptyProjectCustomSrcRoot, mavenEmptyProjectCustomSrcRootModulesData)
    }
}

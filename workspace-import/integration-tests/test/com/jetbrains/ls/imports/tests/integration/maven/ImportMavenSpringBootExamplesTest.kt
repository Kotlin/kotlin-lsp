...
import com.intellij.workspaceModel.integrationTests.data.maven.mavenSpringBootExamples.mavenSpringBootExamplesModulesData
...
class ImportMavenSpringBootExamplesTest {
    @Test
    fun importMavenSpringBootExamples() {
        mavenTest(TestCases.IU.MavenSpringBootExamples, LspTestData.MavenSpringBootExamplesModulesData)
    }
}
